...
| `target_visit_points` | `integer` | NO | — | `ck_target_visit_points`: **`between 10 and 1000`** (`0008`, `not valid`) | Số điểm/đại lý **mục tiêu**. ⚠ **Sàn 10 từ 2026-08-10 — BR-026, DEC-049.** Sàn chỉ áp cho `target`. |
