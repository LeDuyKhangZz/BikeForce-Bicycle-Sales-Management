...
Ảnh telesale đọc `receive_amount` cho THỰC ĐẠT dòng “Doanh thu đã ghi” (Như Quỳnh: 721.709.926), không còn dùng `net_sales`; báo cáo tháng giữ nguyên.

Trang Nhân viên/chi tiết nay đọc snapshot Supabase bằng session Admin và không cần token CRM trên Vercel. Filter/search/pagination ở database. Supabase gen types linked bị từ chối do quyền tài khoản; file generated đã khôi phục nguyên vẹn và không sửa tay.
